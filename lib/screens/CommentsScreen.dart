...
import '../viewholders/CommentsItem.dart';
...
import '../viewholders/CommentsPostHeader.dart';
...
class CommentsScreen extends StatefulWidget {
  ...
  CommentsScreen({Key? key, this.type, this.item, this.commentCount})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (context) => CommentsModel(
            ...
            widget.type,
            widget.type == "article"
                ? (widget.item as Articles).id
                : (widget.item as Videos).id,
            userdata,
            widget.commentCount),
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            CommentsPostHeader(object: widget.item!, type: widget.type!),
            Container(height: 5),
            Expanded(
              child: CommentsLists(),
            ),
